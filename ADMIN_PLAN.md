...
| **회원 관리** | 🔴 1순위 | 목록/검색, 역할 변경(ConfirmDialog), 삭제 | ✅ 완료 |
| **사진 관리** | 🔴 1순위 | 마소니 그리드, 키워드 검색, 5단계 카테고리 필터, 삭제 | ✅ 완료 |
| **포트폴리오** | 🔴 1순위 | 목록, 승인/거절/숨기기/삭제, 상태별 필터 | ✅ 완료 |
| **문의 관리** | 🔴 1순위 | 전체 문의 목록, 읽음/전체읽음/삭제, 미읽음 행 강조 | ✅ 완료 |
| **통계** | 🟡 2순위 | 업로드 추이, 인기 사진 TOP 10, 무드 분포, CSV 내보내기 | ✅ 완료 |
| **시리즈 관리** | 🟢 3순위 | 목록/검색, 삭제 | ✅ 완료 |
...
| 영역 | 항목 | 상태 |
|------|------|------|
| Frontend | Recharts 통계 그래프 | ✅ 구현 완료 |
| Frontend | lucide-react SVG 아이콘 | ✅ 구현 완료 |
| Frontend | react-hot-toast Toast 알림 | ✅ 구현 완료 |
| Frontend | CSS Design Token (tokens.css) | ✅ 구현 완료 |
| Frontend | 다크모드 (prefers-color-scheme) | ✅ 구현 완료 |
| Frontend | 반응형 레이아웃 + 햄버거 메뉴 | ✅ 구현 완료 |
| Backend | Spring Security 6 + JWT 필터 | ✅ 구현 완료 |
| Backend | Spring Data JPA 집계 쿼리 (통계) | ✅ 구현 완료 |
| Backend | 사진/시리즈 키워드 검색 API | ✅ 구현 완료 |
| Backend | 카테고리 5단계 코드 시스템 | ✅ 구현 완료 |
